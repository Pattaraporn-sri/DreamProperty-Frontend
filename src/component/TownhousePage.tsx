      ...
      <Breadcrumb
        ...
        items={[
          ...
          },
          {
            title: (
              <div className="flex">
                <img src={Townhouse} className="h-6 ml-1 -mt-1" />
          ...
          <div className="ml-32">
            ...
            <div className="flex mb-5 bg-gray-100 w-[1300px] p-5 rounded-2xl shadow-lg font-Prompt ">
              <div className="flex">
                ...
                >
                  <h2 className="mt-10 text-xl text-start w-[800px]">
                    {townhouse["ชื่ออสังหาริมทรัพย์"]}
                  </h2>
                  <p className="mt-5 text-lg">ราคา {townhouse["ราคา"]} บาท</p>

                  <div className="flex gap-5 text-gray-700 mt-5 text-sm">
                    <div className="flex">
                      <img src={ruler} className="h-6" />
                      <p className="mt-1 ml-2">{townhouse["ขนาดพื้นที่"]}</p>
                    </div>
                    <div className="flex">
                      <img src={bedroom} className="h-6" />
                      <p className="mt-1 ml-3">{townhouse["ห้องนอน"]}</p>
                    </div>
                    <div className="flex">
                      <img src={bathtub} className="h-6" />
                      <p className="mt-1 ml-3">{townhouse["ห้องน้ำ"]}</p>
                    </div>
                  </div>
