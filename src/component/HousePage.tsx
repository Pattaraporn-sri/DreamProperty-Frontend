    ...
    <div>
      <Breadcrumb className="mt-3 ml-5 font-Prompt">
        ...
        <Breadcrumb.Item className="flex">
          <HomeFilled className="text-[#9D9D9D]" style={{ fontSize: "20px" }} />
      ...
      {houses.length > 0 &&
        houses.map((house) => (
          <div className="ml-48">
            ...
            <div className="flex mb-5 bg-gray-100 w-[1900px] p-5 rounded-2xl shadow-lg font-Prompt ">
              <div className="flex">
                <Link
                ...
                <div
                  key={house.รหัสทรัพย์}
                  className="ml-8 w-[1000px] flex flex-col items-start text-gray-700"
                >
                  <h2 className="mt-10 text-4xl text-start w-[1200px]">
                    {house["ชื่ออสังหาริมทรัพย์"]}
                  </h2>
                  <p className="mt-6 text-3xl">ราคา {house["ราคา"]} บาท</p>

                  <div className="flex gap-5 text-gray-700 mt-5 text-lg">
                    <div className="flex">
                      <img src={ruler} className="h-9"/>
                      <p className="mt-2 ml-2">{house["ขนาดพื้นที่"]}</p>
                    </div>
                    <div className="flex">
                      <img src={bedroom} className="h-9"/>
                      <p className="mt-2 ml-3">{house["ห้องนอน"]}</p>
                    </div>
                    <div className="flex">
                      <img src={bathtub} className="h-9"/>
                      <p className="mt-2 ml-3">{house["ห้องน้ำ"]}</p>
                    </div>
                  </div>

                  <p className="text-start mt-4 text-xl mb-5 w-[1250px]">
                    {house["เกี่ยวกับ"]}
                  </p>
                </div>
              </div>
